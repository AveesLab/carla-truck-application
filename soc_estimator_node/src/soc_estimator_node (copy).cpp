...
SOCEstimatorNode::SOCEstimatorNode() : Node("soc_estimator_node")
{
    ...
    if (mode_ == "LV") {
        ...
        lv_speed_sub_ = this->create_subscription<std_msgs::msg::Float32>(
...
void SOCEstimatorNode::timer_callback()
{
    ...
    if (mode_ == "LV") {
        ...
        LVObj.rtU.Currentspeed = LVObj.rtY.Speedms;
        LVObj.step();
...
void SOCEstimatorNode::publish_output(double soc, double throttle, double brake,
