###########################################################################
## Makefile generated for component 'FV1'. 
## 
## Makefile     : FV1.mk
## Generated on : Thu May 29 11:26:35 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\FV1.exe
...
START_DIR                 = C:\Users\avees\Documents\MATLAB\Examples\R2024b\matlab\EV_Trucks
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
COMPILER_COMMAND_FILE     = FV1_comp.rsp
CMD_FILE                  = FV1.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
NODEBUG                   = 1
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\FV1.exe
...
DEFINES_STANDARD = -DMODEL=FV1 -DNUMST=2 -DNCSTATES=2 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)\FV1_ert_rtw\FV1.cpp $(START_DIR)\FV1_ert_rtw\FV1_data.cpp

MAIN_SRC = $(START_DIR)\FV1_ert_rtw\ert_main.cpp
...
{$(START_DIR)\FV1_ert_rtw}.c.obj:
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\FV1_ert_rtw}.cpp.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\FV1_ert_rtw}.cc.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\FV1_ert_rtw}.cxx.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
FV1.obj : "$(START_DIR)\FV1_ert_rtw\FV1.cpp"
	$(CPP) $(CPPFLAGS) -Fo"$@" "$(START_DIR)\FV1_ert_rtw\FV1.cpp"


FV1_data.obj : "$(START_DIR)\FV1_ert_rtw\FV1_data.cpp"
	$(CPP) $(CPPFLAGS) -Fo"$@" "$(START_DIR)\FV1_ert_rtw\FV1_data.cpp"


ert_main.obj : "$(START_DIR)\FV1_ert_rtw\ert_main.cpp"
	$(CPP) $(CPPFLAGS) -Fo"$@" "$(START_DIR)\FV1_ert_rtw\ert_main.cpp"
