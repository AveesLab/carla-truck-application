###########################################################################
## Makefile generated for component 'LV'. 
## 
## Makefile     : LV.mk
## Generated on : Wed Apr 23 18:50:36 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\LV.exe
...
COMPILER_COMMAND_FILE     = LV_comp.rsp
CMD_FILE                  = LV.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
NODEBUG                   = 1
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\LV.exe
...
DEFINES_STANDARD = -DMODEL=LV -DNUMST=3 -DNCSTATES=2 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)\LV_ert_rtw\LV.cpp $(START_DIR)\LV_ert_rtw\LV_data.cpp

MAIN_SRC = $(START_DIR)\LV_ert_rtw\ert_main.cpp
...
{$(START_DIR)\LV_ert_rtw}.c.obj:
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\LV_ert_rtw}.cpp.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\LV_ert_rtw}.cc.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\LV_ert_rtw}.cxx.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
LV.obj : "$(START_DIR)\LV_ert_rtw\LV.cpp"
	$(CPP) $(CPPFLAGS) -Fo"$@" "$(START_DIR)\LV_ert_rtw\LV.cpp"


LV_data.obj : "$(START_DIR)\LV_ert_rtw\LV_data.cpp"
	$(CPP) $(CPPFLAGS) -Fo"$@" "$(START_DIR)\LV_ert_rtw\LV_data.cpp"


ert_main.obj : "$(START_DIR)\LV_ert_rtw\ert_main.cpp"
	$(CPP) $(CPPFLAGS) -Fo"$@" "$(START_DIR)\LV_ert_rtw\ert_main.cpp"
